...
import { LocationIcon, PhoneIcon, MailIcon, LinkedInIcon, DocumentTextIcon } from './components/icons';
...
const App: React.FC = () => {
  ...
  return (
    <div className="font-sans text-gray-800 antialiased">
      <main className="max-w-4xl mx-auto my-10 md:my-16 p-8 md:p-12 bg-white shadow-2xl rounded-lg">
          ...
          <div className="mt-4 flex flex-wrap justify-center items-center gap-x-6 gap-y-2 text-gray-600">
           ...
           <div className="mt-8 flex justify-center">
             ...
             >
                ...
                <span>Carta para {coverLetter.recipientName}</span>
            </button>
           </div>
        </header>
      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title={coverLetter.title}>
         <div className="space-y-4">
            ...
            {coverLetter.paragraphs.map((p, index) => <p key={index}>{p}</p>)}
